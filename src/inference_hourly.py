...
def predict_latest(
    ...
    Loads the champion model from MLflow registry. If model_path is
    provided explicitly (e.g. from a local file for testing), loads that
    instead. No silent fallbacks — if the registry is empty and no
    explicit path is given, raises FileNotFoundError.
    """
